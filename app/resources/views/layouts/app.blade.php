...
<head>
    ...
    {{-- google API --}}
    <script src="https://maps.googleapis.com/maps/api/js?language=ja&region=JP&key=AIzaSyChXNC5YxqPH251p0ygLbLk5og_Q1mJ1ko&callback=initMap"async defer></script>
...
<body>
    ...
    {{-- https://medium-company.com/popper-min-js-download/　をコピペ 下1行--}}
