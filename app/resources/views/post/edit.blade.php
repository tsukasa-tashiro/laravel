            ...
            {{-- 画像データ選択 --}}
                <div class="card py-4 px-4 mt-2">
                    ...
                    {{-- @php
                        dd($post->image1);
                    @endphp --}}
                    <label for="image1" class="form-label m-2">画像を選択 JPG,JPEG,PNG,GIF</label>
                    <input class="form-control-fime m-1" type="file" name="image1" >
                    <input class="form-control-file m-1" type="file" name="image2">
                    <input class="form-control-file m-1" type="file" name="image3">
